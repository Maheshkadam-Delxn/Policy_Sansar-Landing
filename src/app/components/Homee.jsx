...
const Homee = () => {
  return (
    <div className='w-full h-[88vh] flex flex-col justify-evenly'>


      {/* HERO SECTION HEADLINE */}
      <div className="w-full  flex flex-col items-center justify-center text-center gap-3">
      <h1 className=" font-bold text-8xl">The Insurance Partner</h1>
      <div className='flex items-center gap-2'><h3 className="text-5xl">You can</h3>
      <Image
        ...
        height={70}
      />
      <h3 className="text-5xl">Rely On</h3>
     
      </div>
      <h6 className='text-lg text-[#A3A3A3] font-bold'>Your One-Stop Insurance Shop for Life's Essentials</h6>
    </div>
   ...
   <div className='w-full flex items-center justify-evenly'>
     ...
     <div className='bg-white w-80 h-96 shadow-2xl rounded-xl p-5 flex flex-col gap-3 relative'>
      ...
      <h6 className='text-xs font-bold text-[#A3A3A3]'>Empowering Your Future with the Right Coverage.</h6>
      <Image
        src={family2}
        width={1000}
        height={1000}
