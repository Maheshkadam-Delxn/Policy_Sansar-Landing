...
const Header = () => {
  ...
  return (
    <div className="w-full sticky top-0 z-10">
      <div className="w-full flex items-center justify-between px-4 py-1 text-lg font-medium bg-[#ffffff] text-white shadow-[0_4px_10px_rgba(0,0,0,0.1)] border border-white relative z-99">
