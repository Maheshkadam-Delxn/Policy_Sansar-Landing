    ...
    <div className="mt-12 w-full h-[100vh] relative ">
      ...
      <div className=" flex flex-col justify-between w-full h-[95.5vh]">
        <div className="w-full flex items-center justify-center">
          <div className="w-80 h-44 bg-white shadow-2xl translate-y-16 rounded-2xl p-3 flex flex-col justify-between ">
        ...
        <div className="flex items-center justify-between">
          <div className="w-80 h-44 bg-white shadow-2xl translate-x-16 rounded-2xl p-3 flex flex-col justify-between">
        ...
        <div className="w-full flex items-center justify-between ">
          <div className="w-80 h-44 bg-white shadow-2xl  translate-x-8 rounded-2xl p-3 flex flex-col justify-between">
      ...
      <Image
        ...
        width={1920}
        height={1440}
        className="w-1/2 h-2/3 object-cover absolute bottom-0 left-1/4 "
      />
    </div>
  );
};
