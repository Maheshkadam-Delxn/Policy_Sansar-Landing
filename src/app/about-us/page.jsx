...
const Experts = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description:
        "Mr. Ajaykumar Phate the Chief Marketing Officer of Policy Sansar Insurance Broking Pvt. Ltd is a seasoned professional withover 30 years of extensive experience in the life insuranceindustry. He was associated with HDFC Life, IndiaFirst andMet Life and is Known for his deep expertise in riskassessment, policy management, and customer-centricsolutions, he has consistently demonstrated a strong ability to navigate the complexities of the insurance landscape. Throughout his career, Ajaykumar has been instrumental in driving business growth, building lasting client relationships, and fostering operational excellence.His commitment to delivering tailored insurance solutions and his profound understanding of industry trends make him a trusted leader in the field."
    },
  ];
